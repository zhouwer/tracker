...
public:
    ...
    void predit(KkalmanFilter* kf);
    void update(KkalmanFilter* const kf, const DETECTION_ROW &detection);
    void update(KkalmanFilter* const kf, const DETECTION_ROW & detection, CLSCONF pair_det);
    void mark_missed();
    bool is_confirmed();
    bool is_deleted();
    bool is_tentative();
