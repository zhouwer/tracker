...
void getRandomColors1(vector<Scalar> &colors, int numColors)
{
        RNG rng(0);
...
void MainWindow::on_openButton_clicked()
{
    ...
    cv::Mat ffr;
      ...
      //sleep(3);
        ...
        cv::Mat fram = frame1.tupian.clone();  //得到yolo的检测图
        ...
        getRandomColors(colors, multiTracker->getObjects().size());//得到不同颜色的框子
