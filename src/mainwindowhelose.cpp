...
{
    ui->setupUi(this);
    t=new std::thread(&MainWindow::hello,this);
...
void MainWindow::on_openButton_clicked()
{
   ...
   // sleep(3);
    ...
    //while(capture.read(frame)){
      ...
      std::cout<<"origin img size1:"<<frame.size()<<std::endl;
      //sleep(3);
        ...
        // frame2=frame.clone();
         //frame2=frame;
         std::cout<<"origin img size2:"<<frame3.size()<<std::endl;
         //sleep(3);
         ...
         if(OK_.size() > 0){
             ...
             */
             ...
             for (int i = 0; i < trackerCSRT.size(); i++) {
                ...
                putText(fram, "CSRT Tracker Number:" + to_string(OK_.size()), Point(100, 20), FONT_HERSHEY_SIMPLEX, 0.75, Scalar(50, 170, 50), 2);
...
void MainWindow::hello( ){
    //imshow("ss",fram);
    std::cout<<" fram.."<<fram.size()<<std::endl;
    for (int i = 0; i < trackerCSRT.size(); i++) {
        //TrackerThread_.push_back(CSRT_tracker, &trackerCSRT, &fram, &bboxCSRT, &OK_, i);
        CSRT_tracker;
        // ((CSRT_tracker, &trackerCSRT, &fram, &bboxCSRT, &OK_, i));
       // CSRT_tracker( trackerCSRT, fram, bboxCSRT, OK_, i);
       ...
       // }
        ...
        std::cout<<"1091------------------i=="<<i<<std::endl;
        std::cout<<"1092------------------i=="<<OK_[i]<<std::endl;
        imshow("ss",fram);
...
//void MainWindow::thread(){
   // CSRT_tracker(CSRT_tracker, &trackerCSRT, &fram, &bboxCSRT, &OK_, i);
